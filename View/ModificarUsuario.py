...
class ModificarUsuario():
    def __init__(self):
        ...
        self.icono_modificarr=tk.PhotoImage(file=r"src\icons\user_edit.png")
        self.btnModificar=tk.Button(self.ventana,text="Modificar",image=self.icono_modificar,compound="left")
        self.btnModificar.place(x=70,y=310,width=80,height=25)
